...
// Definimos la interfaz para las propiedades del componente Card
interface CardProps {
    destino: string;
    origen: string;
    precio: string;
...
// Definimos el componente Card con sus propiedades tipadas
...
// Definimos una lista de vuelos con propiedades tipadas
const CardList: React.FC = () => {
    const vuelos: CardProps[] = [
